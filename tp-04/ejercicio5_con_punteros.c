...
void minimo_de_arreglo(int capacidad, int arreglo[], int *min);
void maximo_de_arreglo(int capacidad, int arreglo[], int *max);
void suma_de_arreglo(int capacidad, int arreglo[], int *sum);
// void calc_promedio(int capacidad, int arreglo[]);
...
int main()
{
   ...
   // Realizo calculos
   minimo_de_arreglo(capacidad, arreglo, &min);
   maximo_de_arreglo(capacidad, arreglo, &max);
   suma_de_arreglo(capacidad, arreglo, &sum);
   // calc_promedio(capacidad, arreglo);
   prom = (sum * 1.0) / capacidad; // Aplico truco de multiplicar por 1.0 para convertir la division en flotante
